...
class WebhookConfig
{
    ...
    public function __construct(array $properties)
    {
        ...
        $this->signingSecret = !empty($properties['signing_secret']) ? $properties['signing_secret'] : '';

        $this->signatureHeaderName = !empty($properties['signature_header_name']) ? $properties['signature_header_name'] : '';
